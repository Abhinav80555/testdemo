...
const users=[
  ...
  {name:"Nathiya",
  pic:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRt_rsKgPK6wZmr9pVhqymiEIUre95bD7JVzZ6Irn5mfIKs_QzQNXxv1LCtUk6AJjXOET0&usqp=CAU"},
...
// function Msg(props){
  ...
  return(
    <div className="user-container">
      <img className="propic" src={pic} alt={name} />
      <h1>hi {name} </h1>
      <Counter />
      </div>
  )
